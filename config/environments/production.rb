...
Rails.application.configure do # rubocop:disable Metrics/BlockLength
  ...
  # config.active_job.queue_name_prefix = "ruby_gems_project_production"
  ...
  Rails.application.config.middleware.use ExceptionNotification::Rack,
                                          email: {
                                            deliver_with: :deliver, # Rails >= 4.2.1 do not need this option since it defaults to :deliver_now # rubocop:disable Layout/LineLength
                                            email_prefix: '[PREFIX] ',
